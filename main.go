...
func main() {
	...
	for stopped := false; !stopped; {
		...
		case md := <-metadataSink.Drain():
			...
			// Convert Unix time to Go's time.Time type
			t := time.Unix(md.DiscoveredOn, 0).UTC()
			// Format the time to RFC3339 (which matches your format)
			FormattedTime := t.Format(time.RFC3339)

			//{"infoHash":"0000020FC69B3C2AB388D22FFFAF05C80D6E987D","name":"Daybreak.1993.1080p.AMZN.WEBRip.DDP2.0.x264-BTW","size":5681184768,"publishedAt":"2019-10-11T16:32:58.000Z","source":"rarbg"}
